    ...
    >
      <div className="max-w-7xl mx-auto text-center">
        ...
        <div className="mt-10 flex justify-center">
          <Link
            href="/Journey"
            className="group inline-flex items-center px-6 py-3 bg-gradient-to-r from-blue-500 to-indigo-600 hover:from-blue-600 hover:to-indigo-700 focus:outline-none focus:ring-4 focus:ring-blue-300 rounded-full text-white font-medium shadow-lg transition-transform transform hover:-translate-y-0.5"
