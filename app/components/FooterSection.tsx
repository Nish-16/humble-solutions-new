...
const Footer: React.FC = () => {
    ...
    return (
        <footer
            ref={footerRef}
            className="relative bg-gray-900/50 py-10 px-4 sm:px-12 text-center text-white/60 border-t border-cyan-400/10"
        >
                ...
                <div className="flex justify-center gap-6 mb-6">
                    {socialLinks.map((link) => (
                        <a
                            ...
                            className="gsap-footer-item text-white/70 hover:text-cyan-400 transition-colors duration-300"
                        >
                            {link.icon}
                        </a>
                    ))}
                </div>
                <p className="gsap-footer-item text-sm">
